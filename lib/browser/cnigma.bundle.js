...
define("rsa", ["require", "exports", "buffer"], function (require, exports, buffer_2) {
    ...
    var Rsa = /** @class */ (function () {
        ...
        Rsa.prototype.sign = function (plain, keyBuf) {
            if (keyBuf === void 0) { keyBuf = this.privateKeyBuf; }
            return __awaiter(this, void 0, void 0, function () {
                var privateKey, data, signature, resultBuf;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, crypto.subtle.importKey('pkcs8', keyBuf, {
                                name: 'RSA-PSS',
                                hash: { name: 'SHA-256' },
                            }, false, ['sign'])];
                        case 1:
        ...
        Rsa.prototype.verify = function (plain, sig, keyBuf) {
            if (keyBuf === void 0) { keyBuf = this.publicKeyBuf; }
            return __awaiter(this, void 0, void 0, function () {
                var publicKey, data, signature, isValid;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, crypto.subtle.importKey('spki', keyBuf, {
                                name: 'RSA-PSS',
                                hash: { name: 'SHA-256' },
                            }, false, ['verify'])];
                        case 1:
        ...
        Rsa.prototype.encrypt = function (plain, keyBuf) {
            if (keyBuf === void 0) { keyBuf = this.publicKeyBuf; }
            return __awaiter(this, void 0, void 0, function () {
        ...
        Rsa.prototype.decrypt = function (cipher, keyBuf) {
            if (keyBuf === void 0) { keyBuf = this.privateKeyBuf; }
            return __awaiter(this, void 0, void 0, function () {
